...

{
    ...
    "description": """
Base visual y acceso backend para Tienda LatinPyme en Odoo 19.

Esta fase agrega administracion backend de carruseles sin conectarlos todavia
al home visual estable de tienda.
    """,
    "author": "LatinPyme",
